...
class SimpleGame extends FlameGame with HasTappableComponents {
...
class SplashScreenPage extends Component
    with TapCallbacks, HasGameRef<SimpleGame> {
  @override
  Future<void> onLoad() async {
    addAll([
...
class StartPage extends Component with HasGameRef<SimpleGame> {
  StartPage() {
    addAll([
      _logo = TextComponent(
        text: 'Syzygy',
...
class BackButton extends SimpleButton with HasGameRef<SimpleGame> {
  BackButton()
      : super(
          Path()
            ..moveTo(22, 8)
...
class PauseButton extends SimpleButton with HasGameRef<SimpleGame> {
  PauseButton()
      : super(
          Path()
            ..moveTo(14, 10)
...
class PausePage extends Component with TapCallbacks, HasGameRef<SimpleGame> {
  @override
  Future<void> onLoad() async {
    final game = findGame()!;
    addAll([
